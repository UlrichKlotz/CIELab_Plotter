...
Figure 1: A typical colour space for the pure elements Au, Ag and Cu together with 14-karat gold alloys (0N – white gold, and 1N – yellow gold) and 18-karat gold alloys (2N, 3N, 4N, 5N, 6N). The alloy composition is given in mass-percent. The L-value of 80 is in the typical range for jewellery alloys.

![Screenshot](screenshot_Github2.png)
Figure 2: The complete colour space at L = 70. The L-value can be defined by a slider.

![Screenshot](screenshot_Github3.png)
Figure 3: A screenshot of the GUI that allows interactive selection and editing of data points and axis ranges.
...
```
Additional columns with references can be added. Selected example data is
provided in a CSV file. The software accepts tab-, comma- or semicolon-separated
files.
...
- [6] S. Henderson, D. Manchanda, White gold alloys, Gold Bulletin 38 (2005) 55–67. https://doi.org/10.1007/BF03215234
